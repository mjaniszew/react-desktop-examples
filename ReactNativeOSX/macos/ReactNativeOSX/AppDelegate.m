...
-(id)init
{
    if(self = [super init]) {
        ...
        [windowController setWindowFrameAutosaveName:@"ReactNativeOSX"];
...
#if DEBUG
    sourceURL = [NSURL URLWithString:@"http://localhost:8081/src/MainView.bundle?platform=macos&dev=true"];
#else
...
- (void)setUpApplicationMenu
{
    ...
    [rootMenu addItemWithTitle:@"Quit ReactNativeOSX" action:@selector(terminate:) keyEquivalent:@"q"];
